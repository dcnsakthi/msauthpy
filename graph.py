...
class Graph:
    ...
    async def list_org_users(self):
        # Get all users in the organization
        users_resp = await self.user_client.users.get()
        return users_resp

    async def list_my_activities(self):
        # Get all activities for the signed-in user
        activity_resp = await self.user_client.me.activities.recent.get()
